...
<title>영화 그 이상의 감동. CGW</title> 
	...
	<script type="text/javascript">
		...
		function load_list(){
			...
			var param = 'collection=kmdb_new2&detail=Y&ServiceKey=U8ECM752YKB763PI62AV&releaseDts=20200519&releaseDte=20200618&listCount=32';
		...
		function resultFn(){
			...
			if( xhr.readyState == 4 && xhr.status == 200 ){
				...
				for(var i=0 ; i<json[0].Data[0].Result.length ; i++){
			    	...
			    	if(addButton() >= json[0].Data[0].Result[i].repRlsDate){
